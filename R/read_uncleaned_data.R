...
read_uncleaned_data <- function(path_to_file){
  file_paths <- list("/home/rstudio/data/data2008_not_cleaned.txt",
                     ...
                     "https://raw.githubusercontent.com/DSCI-310/dsci-310-group-13/main/data/datatable2007_uncleaned.txt",
                     "https://raw.githubusercontent.com/DSCI-310/dsci-310-group-13/main/data/datatable2008_uncleaned.txt")
