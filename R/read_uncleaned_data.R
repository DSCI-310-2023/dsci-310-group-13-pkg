...
read_uncleaned_data <- function(path_to_file){
  file_paths <- list("/home/rstudio/data/data2008_not_cleaned.txt",
                     ...
                     "https://raw.githubusercontent.com/DSCI-310/dsci-310-group-13/main/data/uncleaned_data_2007_function_test_only",
                     "https://raw.githubusercontent.com/DSCI-310/dsci-310-group-13/main/data/uncleaned_data_2008_function_test_only")
