...
If you are interested at reading the vignettes for this package, you can click [here](https://dsci-310.github.io/dsci-310-group-13-pkg/articles/Intro_to_youtubeFunction.html). The vignettes are very similar to the Usage section below, but with a little bit more details on how the functions are used in the container. 
